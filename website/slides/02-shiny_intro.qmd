...
1. **Inputs** — widgets the user can interact with (sliders, dropdowns, checkboxes, ...)
2. **Outputs** — things Shiny renders and displays (plots, tables, text, ...)
3. **Instructions** — your code that builds outputs from inputs
...
1. **Shiny Express** — lightweight, great for quick exploration and teaching
2. **Shiny Core** — more explicit, closer to Shiny for R
:::
